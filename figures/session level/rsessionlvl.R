...
las=1, bty="l", log="y",ylim = c(0.4,5))
...
leg.txt <- dat1$author
legend(45,5, leg.txt, pch = 19, col = grpcol, bty = "n", cex = 1, pt.cex = 2, xjust = 0, title = "Headache",title.adj=0)

# Size = 600 x 600
# Discomfort(S5) - ylim = c(0.1,10); legend (50,6.5)
# Fatigue(S6) - ylim = c(0.1,10), xlim = (5,40); legend(25,10)
# Headache(S3) - ylim = c(0.4,5); legend(45,5)
# Paraesthesia(S8) - ylim = c(0.4,6);
