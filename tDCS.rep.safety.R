  ...
  if(is.element(2,level)){
    ...
    ids <- 1:dim(metareg.dat)[1]
    text(metareg.dat$ccharge[ids],exp(metareg.dat$yi)[ids],metareg.dat$author[ids],cex =.6, pos = rep(1,length(metareg.dat)))
